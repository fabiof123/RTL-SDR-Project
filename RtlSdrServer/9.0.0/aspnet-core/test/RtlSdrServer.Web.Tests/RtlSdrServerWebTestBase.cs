...
{
    public abstract class RtlSdrServerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RtlSdrServerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RtlSdrServerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RtlSdrServerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RtlSdrServerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RtlSdrServerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RtlSdrServerDbContext, Task<T>> func)
        {
            T result;
